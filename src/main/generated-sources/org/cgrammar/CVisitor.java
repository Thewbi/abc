...
public interface CVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitForCondition(@NotNull CParser.ForConditionContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitForExpression(@NotNull CParser.ForExpressionContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitForDeclaration(@NotNull CParser.ForDeclarationContext ctx);
